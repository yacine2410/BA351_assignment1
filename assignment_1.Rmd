...
Since the p-values are much smaller than 0.05, we have enough evidence to reject H0, and we can say that the variance for both variables is not constant, showing that there is heteroscedasticity in the regression, so it may not be reliable. 